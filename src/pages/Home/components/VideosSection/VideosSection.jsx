      ...
      <div className="video-container">
        <Tilt transitionSpeed={1000} scale={1.07} className="video-card">
          <ReactPlayer
            ...
            url="https://res.cloudinary.com/dbrnaf0ul/video/upload/v1700582633/Video_in_Cream_Black_Modern_Elegance_Style_zf1cia.mp4"
            playing
            playbackRate={1.15}
            muted
            loop
        ...
        <Tilt transitionSpeed={1000} scale={1.07} className="video-card">
          <ReactPlayer
            ...
            url="https://res.cloudinary.com/dbrnaf0ul/video/upload/v1700578472/samples/cld-sample-video.mp4"
            playing
            playbackRate={1.6}
            muted
            loop
